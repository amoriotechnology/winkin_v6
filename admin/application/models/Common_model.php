...
class Common_model extends CI_Model {
	...
	public function GetJoinDatas($table1, $table2, $joincond, $select, $where = NULL, $wherein = NULL, $groupby = NULL) {
    ...
    public function getRevenue($table1, $table2, $table3, $table1cond, $table2cond, $select, $orderby, $limit, $start, $search = '', $where = NULL) {
